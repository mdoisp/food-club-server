...
export class CompanyAffiliateRestaurantRepository {
  ...
  async create(
    affiliation: Omit<CompanyAffiliateRestaurantEntityInterface, 'id'>
  ): Promise<CompanyAffiliateRestaurantEntityInterface> {
  ...
  async findAffiliation(
    companyId: number,
    restaurantId: number
  ): Promise<CompanyAffiliateRestaurantEntityInterface | null> {
